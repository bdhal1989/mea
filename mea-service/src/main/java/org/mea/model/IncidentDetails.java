...
public class IncidentDetails {
   ...
   private String photo_upload_of_the_person;
   private String image_upload_of_passport;
   ...
   private String accompany_family_member;
   private String accompany_family_member_female_children;
   ...
   public String getPhoto_upload_of_the_person() {
      return this.photo_upload_of_the_person;
   }

   public void setPhoto_upload_of_the_person(String photo_upload_of_the_person) {
      this.photo_upload_of_the_person = photo_upload_of_the_person;
   }

   public String getImage_upload_of_passport() {
      return this.image_upload_of_passport;
   }

   public void setImage_upload_of_passport(String image_upload_of_passport) {
      this.image_upload_of_passport = image_upload_of_passport;
   }
   ...
   public String getAccompany_family_member() {
      return this.accompany_family_member;
   }

   public void setAccompany_family_member(String accompany_family_member) {
      this.accompany_family_member = accompany_family_member;
   }

   public String getAccompany_family_member_female_children() {
      return this.accompany_family_member_female_children;
   }

   public void setAccompany_family_member_female_children(String accompany_family_member_female_children) {
